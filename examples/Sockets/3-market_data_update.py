...
async def main():
    ...
    async def connection_callback():
        ...
        # triggered when market data updates are received
        print("Listening to market data updates")
        await client.socket.listen(SOCKET_EVENTS.MARKET_DATA_UPDATE.value, callback)
