...
async def main():
    ...
    async def connection_callback():
        ...
        # triggered when position updates are received
        print("Listening to user position updates")
        await client.socket.listen(SOCKET_EVENTS.POSITION_UPDATE.value, callback)
